---
title: "SQL Reference"
description: "Describes how to use GridDB's NewSQL interface"
...
See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the details of users and a database.
...
See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the details about the node affinity function, and the rules and the restrictions of naming.
...
-   See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the rules of a database name.
...
- See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)"  for the rule of a table name and a column name.
...
- See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)"  for details of time series table (Time series container).
...
- See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the details of each item.
...
See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for details of each partitioning function.
...
- The partitioning key requires the primary key. To set a key other than the primary key, the restriction in the configuration file need to be removed. For details, refer to the cluster definition file settings in [GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md).
...
- See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the rules of an index name.
...
- See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the rules of a view name.
...
- See "[GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md)" for the rules of a user name.
...
- For the argument role name, specify either an LDAP user name or an LDAP group name. For details, see the [GridDB Features Reference](../3.md_reference_feature/md_reference_feature.md).
- This command can only be executed by the administrative user.
- A user with the same name as an administrator user (admin and system) registered during installation cannot be created.
- The password must consist of ASCII characters. It is case-sensitive.
...
See "[GridDB SQL Tuning Guide](../15.md_sql_tuning_guide/md_sql_tuning_guide.md)" to tune with hint clauses.
